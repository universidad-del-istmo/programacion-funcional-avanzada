...
/* package Elisa-0.1.0.0 */
#ifndef VERSION_Elisa
#define VERSION_Elisa "0.1.0.0"
#endif /* VERSION_Elisa */
#ifndef MIN_VERSION_Elisa
#define MIN_VERSION_Elisa(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Elisa */
...
#define CURRENT_COMPONENT_ID "Elisa-0.1.0.0-inplace-Elisa"
